...
class TestFindConvertibleFiles:
    def test_finds_recursively_and_sorted(self, tmp_path: Path) -> None:
        ...
        # Returns (source, explicit_destination) pairs; destination is None unless the
        # stem is ambiguous and the file needs an injective sidecar name.
        ...
        assert all(dest is None for _src, dest in files), "no ambiguous stems here"
